...
export const sermons = [
...

  {
    ...
    theme: "Divine Direction and Prayer",
    ...
    prophetMessage: {
      ...
      keyPoints: [
        ...
        "God can guide your steps when you submit to Him.",
      ],
      prayerPoints: [
        "Pray for wisdom and direction.",
        "Pray against confusion and delay.",
        "Pray for God to order your steps.",
      ],
      fullNotes: [
        "The prophet explained that divine direction requires trust, prayer, and surrender.",
        "The message focused on the importance of seeking God before making major decisions.",
        "The congregation was encouraged to avoid fear and confusion by remaining connected to God through prayer.",
      ],
    },
